---
name: generic-work-item-scope-definition
...
# generic-work-item-scope-definition

## Context

Use this skill when a user signals they are about to start working on something:
- "Start working on PROJ-1234"
- "I want to work on [feature or area]"
- "Let's begin implementing [some capability]"
- "Start working on this Jira ticket: [URL or key]"

Also use this skill when the user states intent to work on something but there is not enough context to proceed — e.g., no ticket, no feature name, or an ambiguous description. This skill exists to surface that gap and resolve it before any implementation begins.
